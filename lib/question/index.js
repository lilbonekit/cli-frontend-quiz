...
const QuestionBuilder_1 = __importDefault(require("./QuestionBuilder"));
const questionsData = [
    {
    ...
    {
        question: '4) What method is used to make asynchronous requests in the browser?',
    ...
    {
        question: '10) Which protocol is used for decentralized file storage in Web3?',
        answers: ['IPFS', 'HTTP', 'FTP'],
        correctAnswerIndex: 0,
    },
];
exports.questions = questionsData.map((data) => new QuestionBuilder_1.default(data.question, data.answers, data.correctAnswerIndex));
